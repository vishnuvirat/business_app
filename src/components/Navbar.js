...
const Navbar = () => {
 ...
 <>
    ...
    >
      <div className="container px-5 md:px-16 flex items-center justify-between mx-auto">
          ...
          >
            ...
            {["home", "features", "pricing", "testimonial"].map((link) => (
              <li
                key={link}
                className={`${
                  selectedItem === link ? "text-green-800" : ""
                } capitalize border-b py-4 md:border-none md:py-0 hover:text-green-800`}
            ...
            <div className="md:hidden mx-auto absolute bottom-16 left-1/2 -translate-x-1/2 flex gap-3">
              <Link
                ...
                target="_blank"
              >
                <FacebookOutlinedIcon className="cursor-pointer hover:text-green-800 text-xl" />
              </Link>
              <Link
                target="_blank"
                href={"https://www.linkedin.com/in/naseem-khan-275275258/"}
              >
                <LinkedInIcon className="cursor-pointer hover:text-green-800 text-xl" />
              </Link>
              <Link
                target="_blank"
                href={"https://github.com/NaseemKhan005/"}
              >
                <GitHubIcon className="cursor-pointer hover:text-green-800 text-xl" />
              </Link>
              <Link
                target="_blank"
                href={"https://www.instagram.com/naseem_khan005/"}
              >
                <InstagramIcon className="cursor-pointer hover:text-green-800 text-xl" />
              </Link>
            </div>
          </ul>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4 md:gap-2 lg:gap-4">
          <button className="capitalize text-sm sm:text-base border-2 hover:border-2 font-semibold sm:py-3 py-2 px-3 sm:px-6 text-green-800 border-green-800 hover:bg-green-800 hover:text-white rounded-full">
    ...
    {/* Pass the theme as a prop to HeroSection */}
