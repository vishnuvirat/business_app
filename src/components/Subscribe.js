  ...
  return (
    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="container px-6 py-12 mx-auto">
        <div>
          <p class="font-bold text-3xl text-blue-500 dark:text-blue-400">Contact us</p>

          <h1 class="mt-2 text-xl font-semibold text-gray-800 md:text-2xl dark:text-white">
