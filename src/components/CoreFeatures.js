  ...
  return (
    <section className="container mx-auto px-4 md:px-16 flex flex-col lg:flex-row items-center lg:gap-20 gap-14">
      <div className="flex flex-col gap-2 flex-1">
        <span className="text-green-800 uppercase block font-semibold tracking-widest">
          CORE FEATURES
        </span>
        ...
        <button className="mt-5 w-fit md:text-base text-sm hover:border-2 border-2 border-transparent font-semibold py-3 px-8 md:px-10 text-white bg-rose-600 hover:text-green-800 hover:bg-green-800 hover:shadow-rose-600 hover:shadow-2xl rounded-full">
          Explore
        </button>
      </div>
